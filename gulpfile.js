...
const ftp = JSON.parse(fs.readFileSync('./ftp.config'));
...
const paths = {
    src: 'assets/app/src/**/*',
    srcHTML: 'assets/app/src/*.html',
    srcCSS: 'assets/app/src/assets/scss/',
    srcJS: 'assets/app/src/assets/js/',
    srcPhp: 'assets/app/src/assets/php/**/*',
    srcImages: 'assets/app/src/assets/img/**/*',
    srcVideos: 'assets/app/src/assets/videos/**/*',
    srcFonts: 'assets/app/src/assets/fonts/**/*',


    tmp: 'assets/app/tmp',
    tmpIndex: 'assets/app/tmp/index.html',
    tmpHTML: 'assets/app/tmp/**/*.html',
    tmpCSS: 'assets/app/tmp/assets/css',
    tmpJS: 'assets/app/tmp/assets/js',
    tmpPhp: 'assets/app/tmp/assets/php',
    tmpImages: 'assets/app/tmp/assets/img',
    tmpVideos: 'assets/app/tmp/assets/videos',
    tmpFonts: 'assets/app/tmp/assets/fonts/',

    dist: 'assets/app/dist',
    distIndex: 'assets/app/dist/index.html',
    distCSS: 'assets/app/dist/assets/css/',
    distJS: 'assets/app/dist/assets/js/',
    distPhp: 'assets/app/dist/assets/php',
    distImages: 'assets/app/dist/assets/img',
    distVideos: 'assets/app/dist/assets/videos',
    distFonts: 'assets/app/dist/assets/fonts'
...
gulp.task('watch', gulp.series('default', function () {
    ...
    gulp.watch('app/src/*.html').on('change', function (file) {
        const leafname= file.split('\\').pop().split('/').pop();
...
const $documentation = 'Kindly check documentations.html in app\/dist folder for help.\r\n\r\n\r\nFor online docs visit\r\n\r\nhttp:\/\/xvelopers.com\/html\/paper\/documentations.html';
